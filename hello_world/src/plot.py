...
class PlotlyUtility:
    def __init__(
        self, file_name, ratio=1, update_layout=False, height=800, margin=10, showaxis=True
    ):
        ...
        # self.fig.update_yaxes(showline=True)
    ...
    def add_image(self, img):
        ...
        # )
        fig = px.imshow(img)
        self.fig.add_trace(fig.data[0])
        # self.fig.update_layout(
        #     margin=dict(l=0, r=0, t=0, b=0),
        #     xaxis=dict(scaleanchor="y", scaleratio=None),
