...
def main(step_options):
    ...
    def potential_space_cluster():
        ...
        # arranged_library_name = ["FF46", "FF36", "FF13", "FF1"]
        # grid_sizes = [
        #     (mbffg.get_library(x).width, mbffg.get_library(x).height) for x in arranged_library_name
        # ]
        ...
        while True:
            ...
            potential_space = rustlib.calculate_potential_space(
